...
//EMPLOYEE DUTY APIS
    ...
    Route::get('/employees/duties', [EmployeeDutyController::class, 'index']);
    Route::get('/employees/duties/{dutyId}', [EmployeeDutyController::class, 'show']);
    Route::get('/employees/{empId}/duties/requests', [EmployeeDutyController::class, 'getRequestsForAllDuties']);
    ...
    Route::post('/employees/requests/{recordId}/accept', [EmployeeDutyController::class, 'acceptStudent']);
    Route::delete('/employees/requests/{recordId}/reject', [EmployeeDutyController::class, 'rejectStudent']);
    ...
    // Lock a duty regardless of current_scholars
    Route::post('/employees/duties/{dutyId}/lock', [EmployeeDutyController::class, 'lockDuty']);
