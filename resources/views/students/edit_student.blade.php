        ...
        @method('PUT')
          ...
          <div class="registration-layout-input">
            <div>
              ...
              <input
                ...
                value="{{ old('first_name', $student->studentProfile->first_name) }}"
              />
              @if ($errors->any())
            ...
            <div>
              ...
              <input
                ...
                placeholder="ex. john@gmail.com"
                   value="{{ old('last_name', $student->studentProfile->last_name) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('birthday', $student->studentProfile->birthday) }}"
              />
              @if ($errors->any())
          ...
          <div class="registration-layout-input">
            <div>
              ...
              <input
                ...
                value="{{ old('student_number', $student->studentProfile->student_number) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('college', $student->studentProfile->college) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. BSIT"
                value="{{ old('course', $student->studentProfile->course) }}"
              />
              @if ($errors->any())
              @foreach ($errors->get('college') as $error)
                  <p style="color: red">{{ $error }}</p>
          ...
          @endif
            ...
            <div>
              ...
              <input type="text" name="department" class="employee-input" placeholder="CITE" value="{{ old('department', $student->studentProfile->department)}}"/>
              @if ($errors->any())
              @foreach ($errors->get('first_name') as $error)
                  <p style="color: red">{{ $error }}</p>
              @endforeach
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. Y3S1"
                value="{{ old('semster', $student->studentProfile->semester) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. Flex"
                value="{{ old('learning_modality', $student->studentProfile->learning_modality) }}"
              />
              @if ($errors->any())
          ...
          <div class="registration-layout-input">
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. John Doe"
                value="{{ old('father_name', $student->studentProfile->father_name) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. 09xxxxxxxxx"
                value="{{ old('father_contact_number', $student->studentProfile->father_contact_number) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('mother_name', $student->studentProfile->mother_name) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. 09xxxxxxxxx"
                value="{{ old('mother_contact_number', $student->studentProfile->mother_contact_number) }}"
              />
              @if ($errors->any())
          ...
          <div class="registration-layout-input">
            <div>
              ...
              <input
                ...
                value="{{ old('current_address', $student->studentProfile->current_address) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('current_province',$student->studentProfile->current_province) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('current_country',$student->studentProfile->current_country) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('current_city',$student->studentProfile->current_city) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. 1xx Amansabina Mangaldan"
                value="{{ old('permanent_address',$student->studentProfile->permanent_address) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. Pangasinan"
                value="{{ old('permanent_province',$student->studentProfile->permanent_province) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. Philippines"
                value="{{ old('permanent_country',$student->studentProfile->permanent_country) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. Dagupan"
                value="{{ old('permanent_city',$student->studentProfile->permanent_city) }}"
              />
              @if ($errors->any())
          ...
          <div class="registration-layout-input">
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. Angel Doe"
                value="{{ old('emergency_person_name',$student->studentProfile->emergency_person_name) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. 1xx Amansabina Mangaldan"
                value="{{ old('emergency_address',$student->studentProfile->emergency_address) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                value="{{ old('relation',$student->studentProfile->relation) }}"
              />
              @if ($errors->any())
          ...
          @endif
            ...
            <div>
              ...
              <input
                ...
                class="employee-input"
                placeholder="ex. 09xxxxxxxxx"
                value="{{ old('emergency_contact_number',$student->studentProfile->emergency_contact_number) }}"
              />
              @if ($errors->any())
